...
var locNames = ["Snowfall Village", "Amethyst Village", "Ermites Village", "Arrow Villa", "Sunset Town", "Barbarian Village", "Dream Village", "Su Muer Camp", "High-Wind Tribe", "Luoying Village", "Orchid Temple", "Fei Wei Town", "Nanke Village", "Trade-Wind Town", "Lost Village", "Spirit's Boon Temple", "Ancient Great Wall", "Sand Village", "Yelang Village", "Exiled Sprite Village", "Ancient Temple", "Mirror-Lake Residence", "Water-Side Village", "Allied Troop's Camp", "Beiping Town", "Dragon Slope", "Desolate Sky Heritage Ruins", "King-Yu Tripod", "Bamboo Village", "Hunter's House", "Broken-Bridge Village", "Hall of Irresolute Dream", "Languor Village", "Orchid Village", "Nanping Town", "Snowslide Village", "Dragon Fang Village", "Tusk Town", "Expedition Camp", "Midnight-Fire Altar", "Fishing Village", "Fire Village", "Wavebreaker Camp", "Dongping Town", "Ice Village", "Square Village", "Hu Village", "Ancient Wind-Gap", "Unknown Island", "Logging Shed", "Arcadia Town", "Grindstone Village", "Chessboard Valley", "Isle of Broken Dream", "Sky City", "Lili Prairie", "Spirit Valley", "Yujia Forest", "Burial Ground"]
